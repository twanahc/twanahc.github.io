...
$$\Delta h' = \begin{cases}
h_2' - h_1' & \text{if } |h_2' - h_1'| \leq 180° \\
...
$$\bar{h}' = \begin{cases}
\frac{h_1' + h_2'}{2} & \text{if } |h_1' - h_2'| \leq 180° \\
\frac{h_1' + h_2' + 360°}{2} & \text{if } |h_1' - h_2'| > 180° \text{ and } h_1' + h_2' < 360° \\
\frac{h_1' + h_2' - 360°}{2} & \text{otherwise}
\end{cases}$$
